...
<div class="container">
    <div class="col-md-offset-2 col-md-7">
        <h3 class="text-center">Call registration: operator management</h3>
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form:form action="save" cssClass="form-horizontal"
                           method="post" modelAttribute="operator">

                    <!-- need to associate this data with customer id -->
                    <form:hidden path="id"/>

                    <div class="form-group">
                        <label for="cName" class="col-md-3 control-label">cName - login identifier</label>
                        <div class="col-md-9">
